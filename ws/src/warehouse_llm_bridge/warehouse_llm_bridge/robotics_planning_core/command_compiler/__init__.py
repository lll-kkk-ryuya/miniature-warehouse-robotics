...
Standalone, bridge-local OFFLINE core: the L3 chain wires it at ``pipeline.py:187`` (running
caller: x_er_bridge, XER6); it does NOT read ``config`` and does NOT actuate (pure transform).
