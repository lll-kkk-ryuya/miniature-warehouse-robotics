// The 9 KNOWN_LOCATIONS for the 2D map (doc22:331 → config/warehouse.base.yaml:47-56). Embedded
...
export const KNOWN_LOCATIONS: WarehouseLocation[] = [
  { key: "shelf_1", x: 0.2, y: 0.57, kind: "shelf" },
  { key: "shelf_2", x: 0.7, y: 0.57, kind: "shelf" },
  { key: "shelf_3", x: 1.2, y: 0.57, kind: "shelf" },
  { key: "berth_A", x: 0.2, y: 0.8, kind: "berth" },
  { key: "berth_B", x: 0.7, y: 0.8, kind: "berth" },
  { key: "shipping_station", x: 0.45, y: 0.12, kind: "shipping" },
  { key: "charging_station", x: 1.5, y: 0.12, kind: "charging" },
  { key: "retreat_A", x: 0.45, y: 0.78, kind: "retreat" },
  { key: "retreat_B", x: 0.95, y: 0.78, kind: "retreat" },
];
