...
// (no secret on the wire, doc22:254). NEXT_PUBLIC_LANGFUSE_URL is an optional dev convenience and
// must be the PROJECT-scoped base (e.g. https://cloud.langfuse.com/project/<id>) so that
// `${base}/traces/<id>` resolves to Langfuse's canonical trace URL. Without it the trace_id is
// shown as a copyable value the operator can search in Langfuse.
