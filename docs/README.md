...
| [0005-ros2-distro-humble-for-rosmaster-m1](adr/0005-ros2-distro-humble-for-rosmaster-m1.md) | ROS 2 distro を Jazzy→**Humble** へ切替（Orin Nano の Isaac ROS は 3.x=Humble のみ・ROSMASTER M1 の Yahboom 資産が Humble 固定）。代償は Gazebo 公式ペア喪失 |
