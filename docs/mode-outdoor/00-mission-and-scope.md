...
| 5 | **メカナムの扱い** | **決定済（2026-09-13・ユーザー）: 車輪径 150 mm・1:56 のまま・FW clamp を構造根拠に含める（案 A'）**。4WD 維持・メカナム放棄・円弧旋回。実装スライス 1 = `m1_driver` の wheel_scale / odom（branch `feat/m1-wheel-scale-odom`・PR pending）。購入リストは [06 末尾追補](06-hardware-delta-and-base-selection.md)、根拠と退避先（事前相談で否認なら 144 mm へ k のみ変更）は [07 追補③](07-drivetrain-and-wheel-sizing.md) | [07](07-drivetrain-and-wheel-sizing.md) / [06](06-hardware-delta-and-base-selection.md) |
