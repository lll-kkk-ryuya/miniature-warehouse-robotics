...
- **2026-09-14（後半）**: 車輪換装の実測と裁定。実車で軸径 ≈ 6・軸露出 ≈ 19・D 面 15 → Pololu #2674 が付くことを確定。**`OQ-OD76` = 案 2（150 mm 優先: シシク PU-150 ＋ #2674）で裁定**、確定購入リスト（Pololu は #2674 ×5 のみ・国内 MonotaRO 5 点・注文 2 は PU-150 の 4 点確認後）＝ [06 ④-8](06-hardware-delta-and-base-selection.md)。測定図 = [m1-wheel-swap-measure-guide.png](m1-wheel-swap-measure-guide.png)。Pololu 依存の最小化と DigiKey 固定送料 ¥4,428 の確認 = [06 ④-2〜④-5](06-hardware-delta-and-base-selection.md)。
