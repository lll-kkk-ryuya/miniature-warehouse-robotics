...
- [outdoor-architecture-tree.html](outdoor-architecture-tree.html) — 屋外 01-09 機能ツリー（流用 / 変更 / 新規 / 不採用・**09_Remote_Operation 新設**・室内 M1 との差分表）。比較元 = [architecture/robot-architecture-tree.html](../architecture/robot-architecture-tree.html)
