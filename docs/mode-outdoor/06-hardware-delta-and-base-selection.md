...
裁定と実装の正本は [07 追補③](07-drivetrain-and-wheel-sizing.md)。価格は 2026-09-13 参照の税込概算（Pololu は 1 USD = 150 円換算・送料別）。**真の 150 mm で 608 ベアリング・幅 25〜35 mm の PU ソリッド輪は国内即納で見つからなかった**ため、車輪は 2 経路を併記する（`OQ-OD76`）。
