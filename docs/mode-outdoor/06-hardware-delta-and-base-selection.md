...
図: [m1-wheel-swap-measure-guide.png](m1-wheel-swap-measure-guide.png)（上段 = Yahboom 製品写真に 6 か所を注記・下段 A = 車輪を外した軸の断面と #2674 ハブの重ね図・下段 B = PU-150 の断面と 4 か所）。製品写真の出典は Yahboom 商品ページ <https://category.yahboom.net/products/rosmaster-m1>（参照日 2026-09-14）。
...
### ④-7. 実測結果と最終購入リスト（2026-09-14・`OQ-OD69` 前半の答え）
...
### ④-8. 裁定（2026-09-14・ユーザー）: 案 2 = 150 mm 優先（PU-150 ＋ #2674）— 確定購入リスト

④-7 の「#3281 ×4 ＋ PU-150 ×1」は取り下げ。**車輪は 1 種類（シシク PU-150）**、Pololu からは #2674 のみ。`OQ-OD76` = **A'（PU-150 ＋ #2674）で裁定**、退避 = Amazon 6 インチ 車いす前輪（608ZZ 明記）、最終退避 = #3281。
