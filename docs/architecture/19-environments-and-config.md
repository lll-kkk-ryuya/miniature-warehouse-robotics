...
現状ソフトは **Mac M4 + tiryoh(ARM64-native, doc03:266)** で検証。CPU アーキは Jetson Orin Nano Super も
**ARM64**（doc06:91「Mac M4 と Jetson はどちらも ARM64」）/ Ubuntu 22.04（doc03:274）で一致するため
