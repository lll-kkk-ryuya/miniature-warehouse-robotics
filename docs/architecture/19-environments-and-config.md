...
|---|---|---|---|---|
| **G0 安全（必須）** | Layer 0 速度クランプ・近接 estop / Layer 1 Guardian unit | ROS が 0.3 超を出しても MCU が ≤0.3 クランプ・停止。Guardian unit 緑 | **昇格不可**・motion unit を enable しない | doc12:75-84 / doc16:218（unit）/ doc19:21・safety.md |
