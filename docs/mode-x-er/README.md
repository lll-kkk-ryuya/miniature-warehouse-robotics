...
- Mode X-ER config key → **RESOLVED**（2026-07-07・[06 §3 追補](06-unfrozen-contract-resolutions.md)・凍結形=[08 §3](08-x-er-bridge-node-spec.md)）
- calibration artifact の配置と形式 → **RESOLVED**（2026-07-07・同上・`config/<env>/calibration/<id>.yaml`）
