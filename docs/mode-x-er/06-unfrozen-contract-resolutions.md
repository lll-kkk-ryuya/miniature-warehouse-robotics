...
- **live 送信 seam**（`gemini_er.propose_plan` の live path）は #344 で defer＝**pending #344/#389（main 未マージ）**。運用手順 = operator runbook [`../dev/07-mode-x-er-live-e2e-runbook.md`](../dev/07-mode-x-er-live-e2e-runbook.md)。
